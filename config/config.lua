...
Config.MenuExport = 'qb-menu'
Config.TextUIExport = 'textui'
Config.ProgBarExport = 'progressbar'
...
-- TRANSLATIONS
translate = {
	FISHING_FOUND = "You found a couple items and $",
	FISHING_STOP = 'You Stopped Fishing',
	FISHING_NOTDEEP = 'Water isnt deep enough to fish',
	FISHING_ENDED = 'Fishing ended',
	FISHING_ESCAPED = 'The Fish Escaped!',
	FISHING_TUG = 'Fishing Rod Starts to Tug!,
